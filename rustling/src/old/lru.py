...
class DoublyLinkedList:
    ...
    def remove_last(self) -> Node:
        ...
        target_prev.next, self.tail.prev = self.tail, target_prev  # target_prev <==> tail | target
    ...
    def remove_node(self, target: Node) -> Node:
        ...
        target_prev.next, target_next.prev = target_next, target_prev # target_prev <==> target_next  |  target
